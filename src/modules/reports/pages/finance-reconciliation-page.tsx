...
export function FinanceReconciliationPage(){
  ...
  const repairable=report?.issues.filter((item)=>['missing-invoice','missing-credit-note','refund-mismatch'].includes(item.code)).length||0;
