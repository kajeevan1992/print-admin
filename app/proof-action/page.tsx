...
function isReadyForDecision(status: StatusPayload | null) {
  ...
  return proof.customerProofStatus === 'pending-customer-approval' || proof.preflightStatus === 'pass' || proof.preflightStatus === 'warning' || proof.artworkStatus === 'preflight-pass' || proof.artworkStatus === 'design-proof-ready' || proof.customerProofStatus === 'approved';
}
