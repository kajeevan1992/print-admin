...
export async function GET(req: NextRequest) {
  ...
  const result = buildQuoteOrderPrepPayload({
    ...
    productName: textParam(searchParams, 'productName', 'Print product'),
    customerName: textParam(searchParams, 'customerName', ''),
    quoteReference: textParam(searchParams, 'quoteReference', ''),
    validDays: numberParam(searchParams, 'validDays', 14),
