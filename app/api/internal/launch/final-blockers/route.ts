...
export async function GET(request: Request) {
  try {
    ...
    const [main, security, customerData, customerPublicFlow, publicEndpointAbuse, liveEnvironment, designProof, storefrontContent] = await Promise.all([
      ...
      loadReadinessEndpoint(request, '/api/internal/launch/public-endpoint-abuse-audit', 'public-endpoint-abuse-audit', 'Public endpoint abuse', 'Public endpoint abuse audit API', '/public-endpoint-abuse-audit'),
    ...
    return NextResponse.json({
      ...
      upstream: {
        ...
        publicEndpointAbuseAudit: { ok: publicEndpointAbuse.ok, error: publicEndpointAbuse.error, launchStatus: (publicEndpointAbuse.payload as any)?.launchStatus || null, summary: (publicEndpointAbuse.payload as any)?.summary || null },
