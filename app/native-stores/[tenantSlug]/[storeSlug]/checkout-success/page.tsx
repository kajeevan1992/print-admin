...
export default function NativeCheckoutSuccessPage() {
  ...
  useEffect(() => {
    ...
    if (!id) {
      setError('Order reference is missing from the checkout confirmation link.');
      setLoading(false);
      return;
    }
    void loadStatus(id);
