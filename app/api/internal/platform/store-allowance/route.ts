...
import { getStoreAllowanceForTenant, listStoreAllowances, saveStoreAllowance } from '@/core/platform/store-allowance.service';
...
export async function GET(request: Request) {
  try {
    ...
    const data = tenantId ? await getStoreAllowanceForTenant(tenantId) : await listStoreAllowances();
