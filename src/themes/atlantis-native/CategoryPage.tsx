...
export default function CategoryPage({ storeBase, navItems, slug, products = [], categories = [], settings }: { storeBase: string; navItems: NavItem[]; slug: string; products?: ThemeProductCard[]; categories?: ThemeCategoryCard[]; settings?: StorefrontRuntimeSettings }) {
  ...
  return <StorefrontChrome currentPath={`/${slug}`} navItems={navItems} storeBase={storeBase} settings={settings}>
