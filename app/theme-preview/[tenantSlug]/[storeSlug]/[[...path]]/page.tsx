...
import { appendStorefrontContentPageMenuItems } from '@/theme-runtime/content-pages';
...
export async function generateMetadata(): Promise<Metadata> { return { title: 'Draft storefront preview', description: 'Authenticated storefront theme draft preview.', robots: { index: false, follow: false, nocache: true } }; }
...
export default async function ThemeDraftPreview({ params, searchParams }: PageProps) {
  ...
  try { await requireTenantSession(cleanTenantSlug); } catch { notFound(); }
