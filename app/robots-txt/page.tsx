...
export default function Page() {
  return (
    <ConfigWorkspacePage
      storageKey="config-robots"
      title="Robots.txt"
      subtitle="Control indexing directives for search engines and storefront crawlers."
      sections={[
        {
          title: 'Primary Settings',
          fields: [
            { key: 'primaryName', label: 'Primary Name', placeholder: 'Robots.txt profile' },
