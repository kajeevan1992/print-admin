...
const superAdminNavItems: NavItem[] = [
  ...
  { label: 'Owner Compliance Center', href: '/owner-compliance-center', icon: ShieldAlert },
  { label: 'Owner Release Approvals', href: '/owner-release-approvals', icon: CheckCheck },
  { label: 'Owner Data Retention', href: '/owner-data-retention', icon: Archive },
