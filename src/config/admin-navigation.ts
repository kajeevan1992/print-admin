...
const ADMIN_SIDEBAR_NAVIGATION: AdminSidebarNavigationItem[] = [
  ...
  { label: 'Launch Operations', iconKey: 'Rocket', order: 265, roles: TENANT_ROLES, children: [
    ...
    { label: 'Payment Checkout QA', href: '/payment-checkout-qa', iconKey: 'CreditCard', order: 18 },
  ...
  { label: 'Content', iconKey: 'FileText', order: 310, roles: TENANT_ROLES, children: [
    ...
    { label: 'Category CMS / SEO', href: '/category-cms', iconKey: 'Tags', order: 70 },
    { label: 'Menu Builder', href: '/menu-builder', iconKey: 'LayoutPanelTop', order: 75 },
