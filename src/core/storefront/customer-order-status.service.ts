...
function deriveCurrentStage(order: Store, ticket: Store | null, plannerJob: Store | null) {
  ...
  if (ticket?.customerProofStatus || ticket?.artworkStatus || ticket?.preflightStatus) return 'proof';
