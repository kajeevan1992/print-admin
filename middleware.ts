...
const PROTECTED_PAGE_PREFIXES = ['/', '/workspace', '/super-admin', '/products', '/categories', '/orders', '/settings', '/tenant-control', '/shop-login-setup', '/memberships', '/fresh-db-setup', '/admin-users', '/api-keys', '/credentials', '/security-events', '/database-manager'];
