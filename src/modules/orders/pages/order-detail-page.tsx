...
export function OrderDetailPage({ id }: { id: string }) {
  ...
  async function runPaymentAction(action: PaymentAction) {
    ...
    try {
      ...
      const response = await ordersService.adminPaymentAction(order.id, { action, note: paymentNote, reference: paymentReference, amountMinor, actor: 'admin', paymentProvider: action === 'stripe-refund' ? 'stripe' : order.paymentProvider || 'manual', reason: 'requested_by_customer' });
